      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-xl font-body text-lead text-ink-soft">
            Hiring AI or cloud engineers? Or just want to talk about agents,
            retrieval, or what it takes to run them on AWS? Send me an email,
            put time straight on my calendar, or find me on LinkedIn. Whichever
            you pick, I&apos;ll get back to you within a day.
          </p>
