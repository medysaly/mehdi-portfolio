  ...
  return (
    <>
      ...
      >
        ...
        {/* Slottable, so `asChild` can hand these decorations to a real <a>.
            Without it Radix's Slot sees four children and throws, which makes
            asChild unusable for link CTAs. It has to wrap `children` directly,
            or Slot clones the wrapper instead of the anchor. Callers put their
            own `relative z-10` on the label so it sits above the shadow layer.
            Only deviation from the export. */}
