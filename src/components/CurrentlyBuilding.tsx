    ...
    <section className="px-6 py-16">
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          {/* Glow effect */}
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-accent/[0.04] via-transparent to-transparent" />

          <div className="relative grid gap-6 p-8 md:grid-cols-5 md:items-center md:p-10">
            ...
            <div className="flex flex-col gap-4 md:col-span-2">
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={tag}
                    className="rounded-md border border-accent/15 bg-accent/5 px-3 py-1.5 text-xs text-accent-glow/80"
                  >
                    {tag}
                  </span>
                ))}
